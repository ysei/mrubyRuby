...
Q&A：
  Q：そもそも動かないんだが
  A：2013/08/15の時点のソースコードから読み上げて実装されております。
  2013/11/25現在ですでにフォーマットのバージョンが上がっていますので
  最新の環境でmrbcしたファイルには対応していません。

  Q：8/15版でもError: Type mismatchとか出てるんだけど
  A：MRB_NAN_BOXINGが有効かどうかで出力が変わるというバグのためです。
  ※2013/11/25現在のトランクでは修正済み
  MRB_NAN_BOXINGがOFFのmrbcを使用してください。
...
0001を解析したのは自作アプリth135_aiというのにつんだmrubyが0001だったから。
8/15版なのもそのあたりからきている。
